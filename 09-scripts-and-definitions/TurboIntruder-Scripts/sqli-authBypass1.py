...
payload_path = PAYLOAD_HOME + "/01-attacks/sqli/sqli-payloads-true_false.txt"
previousReq = ""
previousResponseLength = 0
previousWords = ""

failedAttemptKeyword ='Invalid username or password.'
...
def handleResponse(req, interesting):
    ...
    # if any unusual response show me.
    if failedAttemptKeyword not in req.response:
        table.add(req)
